...
const Modal = () => {
	...
	const watchSelectedFolder = watch("selectedFolder");
	const watchBookmarkTitle = watch("bookmarkTitle");
	...
	const handleAddToExistingBookmark = () => {
		...
		if (!watchBookmarkTitle) {
			setValue('bookmarkTitle', createBookmarkNameWithTime());
		}
	};
										...
										<div className="space-y-6 text-left">
											<div>
												...
												<div className="relative">
													<select
														{...register("selectedFolder", { required: true })}
										...
										<div className="space-y-6 text-left">
											<div>
												...
												<input
													...
													{...register("bookmarkTitle", { required: true, validate: value => !!value.trim() })}
											...
											<div className="flex gap-3 pt-4">
												...
												<button
													type="submit"
													disabled={!watchBookmarkTitle || !watchBookmarkTitle.trim()}
													className="flex-1 py-4 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-bold rounded-2xl transition-all active:scale-[0.985]"
												>
													Create New Bookmark
												</button>
